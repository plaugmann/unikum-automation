...
- `GET /item/<id>.html` – én besked alene. Feedets links peger hertil, fordi
  Unikum kræver BankID og et klik derfor ville ende på login-siden.
- `GET /items.html` – oversigt med alle beskeder.
